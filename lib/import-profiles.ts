...
export const importCoreTargets = [
  ...
  { key: "shelfCode", label: "Regal-Code" },
  { key: "drawerCode", label: "Drawer-Code" },
  { key: "binSlot", label: "Unterfach" },
  { key: "name", label: "Name" },
...
const importCoreFieldAliases: Record<string, string[]> = {
  ...
  shelfCode: ["shelf", "shelfcode", "regal", "regalcode", "bereich", "bereichscode"],
  drawerCode: ["drawer", "drawercode", "bin", "bincode", "fach", "fachcode"],
  binSlot: ["slot", "binslot", "unterfach", "slotnummer"],
