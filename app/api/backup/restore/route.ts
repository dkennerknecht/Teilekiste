...
export async function POST(req: NextRequest) {
  ...
  if (strategy === "overwrite") {
    await prisma.$transaction([
      ...
      prisma.inventorySessionRow.deleteMany(),
      ...
      prisma.categoryTypeCounter.deleteMany(),
  ...
  return NextResponse.json({
    ...
    restoredBins: result.restoredBins,
    ...
    restoredCategoryTypeCounters: result.restoredCategoryTypeCounters,
